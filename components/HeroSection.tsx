    ...
    <section className="relative h-[90vh] flex flex-col items-center justify-center bg-gradient-to-b from-primary/10 to-background overflow-hidden mb-12">
      ...
      <div className="container px-4 mx-auto flex flex-col items-center justify-center relative z-10">
        ...
        >
          ...
          >
            Estudante do curso superior de Análise e Desenvolvimento de Sistemas no IFPR e Desenvolvedor na INML/ATLAS
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
              <Button
                ...
                asChild
              >
                <a href="mailto:eduardoszchaida@gmail.com">
              ...
              >
                <a
                  href="https://www.linkedin.com/in/eduardo-szchaida/"
                  target="_blank"
              ...
              >
                <a
                  href="https://github.com/duduszchaida"
                  target="_blank"
                  rel="noopener noreferrer"
                >
