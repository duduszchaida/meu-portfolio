...
export default function App() {
  ...
  // Links .env
  const resumePortuguese = "curriculo.pdf";
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {[              
                ...
                { name: 'Filmes clássicos', color: 'hover:bg-green-200' },
                { name: 'Games', color: 'hover:bg-yellow-200' },
                { name: 'Inovação', color: 'hover:bg-purple-200' },
                { name: 'Catolicismo', color: 'hover:bg-orange-200' },
          ...
          >
            <div className="space-y-6">
              ...
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6 text-justify">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                  ...
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-center gap-2">
                      ...
                      <span className="hover:text-blue-600 transition-colors">Concluindo o curso superior de ADS no IFPR</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-lg">💻</span>
                ...
                <p>
                  Descobri o mundo da programação durante meu ensino médio, no qual meu grupo na feira de ciências desenvolveu um site voltado ao ensino de matemática básica atráves de um jogo simples e divertido. A partir dai foi amor a primeira vista, descobri um mundo onde com infinitas possiblilidades onde posso resolver diversos problemas do dia a dia com &quot;algumas&quot; linhas de código.
                </p>
                <p>
